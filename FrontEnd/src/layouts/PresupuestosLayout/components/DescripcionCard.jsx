...
export default function DescripcionCard({ descripcion, onDescripcionChange }) {
  return (
    <div
    ...
    >
      ...
      <div className="pt-2 h-full flex flex-col">
        <p className="text-sm text-gray-500">Descripción del Proyecto</p>

        {/* Textarea */}
        <textarea
          value={descripcion}
          onChange={(e) => onDescripcionChange(e.target.value)}
          placeholder="Agrega aquí la descripción del proyecto o presupuesto..."
