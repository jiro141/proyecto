...
export default function TableHeader({
  ...
  const isResumenCostos = titulo === "Resumen de Costos";
  const hasEtapa = typeof etapa === "number";
  const isFinal = hasEtapa && etapa >= 0;
  const hasIcon = Boolean(icon);
  return (
    <div className=" items-center justify-between mb-4">
      {isResumenCostos && (<div className="flex items-center">
        {
          !isFinal && hasIcon && (<div
